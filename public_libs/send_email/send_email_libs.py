...
username = "40308351@qq.com"              #qq账户
authorization_code = "lwaysxhflnfacaia"     #qq邮箱授权码
from_email = "xunyouqingxi@gmail.com"            #发送的邮箱
...
def send_qq_plain_email(from_email, to_emails, title, content):
    ...
    for to_email in to_emails:
        ...
        message["Subject"] = u"{}--邮箱测试".format(title).encode('utf-8')  # 标题,整体进行utf-8编码
...
def send_qq_html_email(from_email, to_emails, title, content):
    ...
    for to_email in to_emails:
        ...
        message["Subject"] = u"{}--邮箱测试".format(title).encode('utf-8')  #标题整体进行utf-8编码
...
if __name__ == "__main__":
    ...
    """
    #收件人邮箱地址
    to_email = ["xunyouqingxi@gmail.com"]

    #邮箱附件文件名，打开的是本目录文件
    attachs = ["send_email_libs.txt", "send_email_libs.py"]
    ...
    # 测试发送文本邮件
    #send_fail = send_qq_plain_email("3002832062@qq.com", to_email, u"第一课", content)

    #测试发送html邮件
    send_fail = send_qq_html_email("40308351@qq.com", to_email, u"第一课", content)
    #测试发送带附件邮件
    #send_fail = send_qq_attach_email("3002832062@qq.com", to_email, u"第一课", content, attachs)
    #测试发送同时带图片和附件的邮件
    #send_fail = send_qq_img_email("3002832062@qq.com", to_email, u"第一课", img_content, attachs, imgname)
    print send_fail
